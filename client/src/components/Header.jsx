...
export default function Navbar() {
  ...
  const navigation = [
    ...
    { name: "External Resources", to: "/externalAPI", current: false },
  ];
                ...
                <div className="w-full sm:max-w-xs">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      id="search"
                      name="search"
                      className="block w-full rounded-md border-0 bg-gray-700 py-1.5 pl-10 pr-3 text-gray-300 placeholder:text-gray-400 focus:bg-white focus:text-gray-900 focus:ring-0 focus:placeholder:text-gray-500 sm:text-sm sm:leading-6 cursor-not-allowed"
                      placeholder="Search"
                      type="search"
                    />
                  </div>
